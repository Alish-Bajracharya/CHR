...
@section('content')
      ...
      <div
        ...
        style="
          height: 800px;
          background: url('{{asset('assets/images/304A9030.jpg')}}') center center/cover no-repeat;
        "
      >
...
<div class="row pe-4">
    <div class="col-lg-4 col-md-5 col-xs-6 thumb">
        <a href="{{asset('assets/images/chr-conference-4.JPG')}}" class="fancybox" rel="ligthbox">
            <img src="{{asset('assets/images/chr-conference-4.JPG')}}" class="zoom img-fluid" alt="">
        </a>
    </div>
    <div class="col-lg-4 col-md-5 col-xs-6 thumb">
        <a href="{{asset('assets/images/chr-conference-2.JPG')}}" class="fancybox" rel="ligthbox">
            <img src="{{asset('assets/images/chr-conference-2.JPG')}}" class="zoom img-fluid" alt="">
        </a>
    </div>
    
    
    <div class="col-lg-4 col-md-5 col-xs-6 thumb">
        <a href="{{asset('assets/images/chr-conference-3.JPG')}}" class="fancybox" rel="ligthbox">
            <img src="{{asset('assets/images/chr-conference-3.JPG')}}" class="zoom img-fluid" alt="">
        </a>
    </div>
  ...
  <!-- <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-ride="carousel" data-bs-interval="500">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{asset('assets/images/chr-conference-4.JPG')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{asset('assets/images/chr-conference-2.JPG')}} " class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{asset('assets/images/chr-conference-3.JPG')}} " class="d-block w-100" alt="...">
        </div>
    </div>
