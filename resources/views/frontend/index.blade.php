                        ...
                        <ul class="uk-slideshow-items" style="min-height: max(300px, 100vh)">
                            @foreach($slider as $item)
                                ...
                                @foreach($images as $image)
                                    <li class="el-item">
                                        <picture>
                                            <img src="{{ asset('storage/' . $image) }}" class="el-image" alt="{{ $item->title }}" loading="lazy" uk-cover />
                                        </picture>
                                    </li>
                                @endforeach
                            @endforeach
                ...
                <div class="uk-width-1-2@m">
                  <div
                    ...
                    <div class="el-content uk-panel uk-margin-top">
                      <img src="{{ asset('storage/' . $aboutUs->main_image) }} " />
                    </div>
                  </div>
                </div>
                <div class="uk-grid-item-match uk-width-1-2@m">
                  <div class="uk-tile-muted uk-tile">
                    ...
                    <div class="uk-margin uk-width-medium uk-margin-auto">
                      <a class="el-content uk-button uk-button-text" href="{{route('about-us.show')}}">
                        READ THE STORY
                      </a>
                    </div>
                  </div>
            ...
            <div class="uk-light cf-emotion-accordion">
              <div class="cf-container cf-breakpoint cf-breakpoint-" style="height: 700px">
                <div class="cf-source uk-cover-container">
                  <img class="cf-default cf-source-content" alt="" uk-cover data-src=" {{asset('assets/images/chr-menubar.jpg')}} " uk-img />
                  <img class="cf-673c846ea1d5e cf-source-content" alt="" uk-cover data-src="{{asset('assets/images/slide05.jpg')}} "
                    uk-img />
                  <img class="cf-673c846ea1d62 cf-source-content" alt="" uk-cover data-src="{{asset('assets/images/chr-champadeviforest.jpg')}}"
                    uk-img />
                  <img class="cf-673c846ea1d64 cf-source-content" alt="" uk-cover data-src="{{asset('assets/images/enjoy_spa_01.webp')}}"
                    uk-img />
                </div>
...
<section class="explore-rooms-section  py-5">
  <div class="container">
    ...
    <!-- Room Cards -->
    <div class="row g-4">
      @php $rooms = \App\Models\Room::all(); @endphp
      ...
      <div class="col-12">
        <div class="explor_item d-flex room-card flex-md-row flex-column">
          ...
          <div class="col-md-4 p-0">
            <a href="{{ route('room.detail', $room->id) }}" class="room_image d-block h-100">
          ...
          <div class="col-md-8 explor_text d-flex flex-column justify-content-between">
            <div>
              <a href="{{ route('room.detail', $room->id) }}">
                <h4 class="text-start mb-2" style="color: #025E5B;">{{ $room->name }}</h4>
              </a>

              <!-- Occupancy & Bed Info -->
              <p class="mb-2" style="color: #444;">
                <strong>Occupancy:</strong> {{ $room->occupancy ?? '2 Adults, 1 Child' }} |
                <strong>Bed:</strong> {{ $room->bed_type ?? 'Twin Bed' }}
              </p>

              <!-- Description with Read More -->
              <div id="desc-{{ $room->id }}" class="room-description">
                {{ $room->description ?? 'Experience a perfect stay with scenic views, traditional design, and modern amenities tailored for your comfort. Relax on a private balcony, soak in nature, and enjoy a memorable retreat.' }}
              </div>
              <span class="room-readmore-btn" onclick="toggleRoomDesc({{ $room->id }})">Read more</span>
  ...
  padding-bottom: 3rem !important;
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 px-0 px-md-3 mb-3 mb-md-0">
        <img src="{{asset('assets/images/chr-indravirbar.jpg')}}" alt="Indra Bir Bar" class="explore-img w-100" />
      </div>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-3 mb-md-0">
        <img src="{{asset('assets/images/chr-contact.jpg')}}" alt="Seesh Mahal" class="explore-img w-100" />
      </div>
      <div class="col-md-6">
        <div class="explore-card">
          <h3>Seesh Mahal</h3>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-3 mb-md-0">
        <img src="{{asset('assets/images/chr-swimming.jpg')}}" alt="Lachhi Pool" class="explore-img w-100" />
      </div>
      <div class="col-md-6">
        <div class="explore-card">
          <h3>Lachhi Pool</h3>
    ...
    <div class="row align-items-center mb-5 flex-md-row-reverse">
      <div class="col-md-6 mb-3 mb-md-0">
        <img src="{{asset('assets/images/chr-contact (2).png')}}" alt="Coffee Shop" class="explore-img w-100" />
      </div>
      <div class="col-md-6">
        <div class="explore-card">
          <h3>Coffee Shop</h3>
    ...
    <div class="row align-items-center mb-5">
      <div class="col-md-6 mb-3 mb-md-0">
        <img src="{{asset('assets/images/gym.jpeg')}}" alt="Gym" class="explore-img w-100" />
      </div>
      <div class="col-md-6">
        <div class="explore-card">
          <h3>Gym</h3>
        ...
        <div class="row align-item-center">
          <h2 class="section-title text-center">In the Resort</h2> -->
            ...
            <!-- <div class="col-lg-5" style="position: relative;">
                ...
                <div class="card">
                    <img src="{{asset('assets/images/chr-content.jpg')}}" alt="Wedding Decoration" class="img-fluid">
                </div>
                ...
                <li class="cards_item">
                    <div class="card">
                        <div class="card_image">
                            <img src="{{ asset('storage/' . $offer->image) }}" loading="lazy" class="w-100" style="height:240px;" alt="{{ $offer->title }}">
                        </div>
                        <div class="card_content">
                            <h2 class="card_title">{{ $offer->title }}</h2>
                            <div class="card_text">
              ...
              <div class="col-lg-8 col-md-10 col-sm-12">
                  <div class="testimonial-card text-center">
                      ...
                      <div class="d-flex align-items-center justify-content-center mt-4 flex-column flex-md-row gap-3">
                          <img
                              src="{{ asset('assets/images/alish.jpg') }}"
                              alt="user"
                              class="reviewer-img"
                          />
                          <div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-md-10">
                        <div class="testimonial-card text-center">
                            ...
                            <p class="testimonial-text fst-italic">“{{ $review->review }}”</p>
                            <div class="d-flex align-items-center justify-content-center mt-4 flex-column gap-2">
                                <img src="{{ asset('storage/' . $review->reviewer_image) }}" alt="user" class="reviewer-img" />
                                <div class="text-center">
                                    <h5 class="fw-bold m-0 text-color">{{ $review->reviewer_name }}</h5>
                                    <small class="text-muted d-block">{{ $review->designation }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row about-section-margin">
          <div class="col-md-4">
            <a href="https://chr.com.np/local-attraction" class="card-new">
             ...
             <img
                ...
                src=" {{asset('assets/images/chr-jatra.jpeg') }}"
          ...
          <div class="col-md-4">
             <a href="lhttps://chr.com.np/local-attraction" class="card-new">
              ...
              <img
                class="card-new__background"
                src=" {{asset('assets/images/chr-localfarm.jpg') }}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
          ...
          <div class="col-md-4">
             <a href="https://chr.com.np/local-attraction"class="card-new">
              <img
                class="card-new__background"
                src="{{asset('assets/images/chr-village-tur.jpeg') }}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
     ...
     <div class="row">
          ...
          <div class="col-md-4">
             <a href="https://chr.com.np/major-attractions"  class="card-new">
              <img
                class="card-new__background"
                src="{{asset('assets/images/dakshinkali-natural-beauty.png')}}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
          ...
          <div class="col-md-4">
              ...
              <a href="https://chr.com.np/major-attractions" class="card-new">
                <img
                class="card-new__background"
                src="{{asset('assets/images/chr-gurupadmassana.jpeg')}}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
     ...
     <div class="row">
          <div class="col-md-4">
            <article class="card-new">
              <img
                class="card-new__background"
                src="{{asset('assets/images/taudaha.jpeg')}}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
          ...
          <div class="col-md-4">
            <article class="card-new">
              <img
                class="card-new__background"
                src="{{asset('assets/images/hiking near champadevi.jpg')}}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
          ...
          <div class="col-md-4">
            <article class="card-new">
              <img
                class="card-new__background"
                src="{{asset('assets/images/mountainbiking.webp')}}"
                alt="Photo of Cartagena's cathedral at the background and some colonial style houses"
                width="1920"
                height="2193"
              />
