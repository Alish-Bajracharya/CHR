<?php include 'header.php'  ?>
      <div
        ...
        style="
          max-height: 850px;
          min-height: 680px;
          background: url('./images/chr-superior.jpg') center center/cover no-repeat;
        "
      >
        <!-- Overlay -->
      ...
      <div class="container">
        <div class="d-flex align-items-center">
          <div class="col-md-9 d-flex flex-column align-items-center" style="background-color: #1b6e6b; padding:20px;box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
            ...
            <p class="fs-5 text-white" style="margin-top: 25px;">365 m<sup>2</sup></p>
          </div>
          
          <div class="col-md-9 d-flex flex-column align-items-center" style="background-color: #347e7b;padding:23px;">
            <i class="fas fa-bed icon "></i>
            <p class="fs-5 text-white" style="margin-top:20px">Superior Room</p>
          </div>

          <div class="col-md-9 d-flex flex-column align-row items-center" style="background-color: #4d8e8c; padding:35px;">
            <i class="fas fa-user mt-1" style="color: white; font-size: 30px;"></i>
            <p class="text-white mt-3">7 per </p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="500">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="./images/chr-superiorromm-1.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./images/chr-superiorroom-2.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="./images/chr-superiorroom-3.jpg" class="d-block w-100" alt="...">
            </div>
        </div>
      ...
      <div class="container py-5 custom-margin-padding">
        <div class="row">
          ...
          <div class="col-lg-5">
           ...
           <a href=""><button id="myBtn1">Book Now</button></a> 
          </div>
          ...
          <div class="col-lg-8 col-md-10 col-sm-12">
            <div class="p-4 text-center">
              ...
              >
                ...
                />
                <div>
                  <h5 class="fw-bold p-0  text-color">Sushila Kafle</h5>
