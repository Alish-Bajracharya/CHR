...
@section('content')
      <div
        ...
        style="
          height: 800px;
          background: url('{{asset('assets/images/304A8955.jpg')}}') center center/cover no-repeat;
        "
      >
    ...
    <div class="row justify-content-center pe-4">
      <div class="col-lg-8 col-md-10 col-sm-12">
        <div class="text-center">
              <h2>Bishnudevi & Birkheshwor Hall</h2>
              <p>Small Hall having 70 seating, P2.5 LED Screen (1.92 mtr x 3.2 mtr size), Audio
                & Video system, floor box (power socket & Net Interface) surrounding – 2 Hall
  ...
  <!-- <div id="carouselExampleControlsNoTouching" class="carousel slide" data-bs-touch="false" data-bs-interval="500">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{asset('./assets/images/chr-bhagbhairav-5.jpg')}} " class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{asset('./assets/images/chr-bhaghbhairav-3.jpg')}}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{asset('./assets/images/chr-bhaghbhaira-4.jpg')}} " class="d-block w-100" alt="...">
        </div>
    </div>
...
<div class="container page-top ">
        <div class="row pe-4">
            <div class="col-lg-4 col-md-5 col-xs-6 thumb">
                <a href="{{asset('./assets/images/chr-bhagbhairav-5.jpg')}}" class="fancybox" rel="ligthbox">
                    <img src="{{asset('./assets/images/chr-bhagbhairav-5.jpg')}}" class="zoom img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-5 col-xs-6 thumb">
                <a href="{{asset('./assets/images/chr-bhaghbhairav-3.jpg')}}" class="fancybox" rel="ligthbox">
                    <img src="{{asset('./assets/images/chr-bhaghbhairav-3.jpg')}}" class="zoom img-fluid" alt="">
                </a>
            </div>
            <div class="col-lg-4 col-md-5 col-xs-6 thumb">
                <a href="{{asset('./assets/images/chr-bhaghbhaira-4.jpg')}}" class="fancybox" rel="ligthbox">
                    <img src="{{asset('./assets/images/chr-bhaghbhaira-4.jpg')}}" class="zoom img-fluid" alt="">
                </a>
            </div>
