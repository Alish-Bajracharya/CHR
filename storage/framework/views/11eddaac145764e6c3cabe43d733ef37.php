...
<style>
    ...
    footer::before {
        ...
        width: 100%;
        height: 100%;
        background-image: url('<?php echo e(asset('assets/images/rb_2150429154.png')); ?>');
        opacity: 0.25;
    ...
    <div class="container footer-container">
        <div class="row gx-3 gy-2 mt-2">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <ul class="quick-links">
                    ...
                    <li><a href="<?php echo e(route('about-us.show')); ?>">About Us</a></li>
            ...
            <div class="col-12 col-md-6 col-lg-3">
                ...
                <ul class="menu">
                    <li><a href="<?php echo e(route('balkumari.show')); ?>">Balkumari</a></li>
                    <li><a href="<?php echo e(route('bishnudevi')); ?>">Bishnudevi & Birkheshower</a></li>
                    <li><a href="<?php echo e(route('bagh')); ?>">Baghbhairab</a></li>
                </ul>
            </div> -->
            ...
            <div class="col-12 col-md-6 col-lg-3 h-30">
                ...
                <div class="payment mt-3">
                    <img src="<?php echo e(asset('assets/images/esewa.png')); ?>" alt="eSewa" />
                    ...
                    <img src="<?php echo e(asset('assets/images/fonepay.png')); ?>" alt="Fonepay" />
                </div>
            </div>
        </div>
        ...
        <div class="text-center mt-3 mb-3">
            <div class="d-flex justify-content-center align-items-center mb-2">
                ...
                <a href="#"><img src="<?php echo e(asset('assets/images/assets/whilelogo.png')); ?>" alt="Logo" width="200"></a>
                <div class="border border-white w-25"></div>
            </div>
...
<a href="https://wa.me/9763699009" class="emergency-chat" title="Emergency Chat" target="_blank">
    ...
    <?php /**PATH C:\xampp\htdocs\CHR\resources\views/partials/frontend_footer.blade.php ENDPATH**/ ?>