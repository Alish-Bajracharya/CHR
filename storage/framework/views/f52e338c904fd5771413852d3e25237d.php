            ...
            <nav class="uk-navbar"
              ...
              <div class="uk-navbar-left">
                <a href="https://chr.com.np" aria-label="Back to home" class="uk-logo uk-navbar-item">
                  <img alt="CHR" loading="eager" width="80" height="67" src="<?php echo e(asset('assets/images/assets/removebg-preview.png')); ?>" /></a>
              </div>
            </nav>
          </div>
        </div>
            ...
            <div class="uk-margin-auto-bottom">
                <div class="uk-panel" id="module-menu-dialog-mobile">
                    <ul class="uk-nav uk-nav-default">
                        ...
                        <li class="item-150"><a href="<?php echo e(route('about-us.show')); ?>" class="text-white"> About CHR</a></li>
                        ...
                        <div class="dropdown-container-1">
                            ...
                            <?php $__currentLoopData = $rooms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(route('room.detail', $room->id)); ?>" class="text-white mb-3"><?php echo e($room->name); ?></a>
                        ...
                        <li class="item-153">
                            ...
                            ?>
                            <?php if($restaurant): ?>
                                <a href="<?php echo e(route('restaurant.detail', $restaurant->slug)); ?>" class="text-white">Restaurant &amp; Bar</a>
                        ...
                        <div class="dropdown-container-1">
                            <a href="<?php echo e(route('balkumari.show')); ?>">BallKumari Hall</a><br>
                            <a href="<?php echo e(route('bishnudevi')); ?>">Bishnudevi Hall</a><br>
                            <a href="<?php echo e(route('bagh')); ?>">Bagh Bhairab Hall</a><br>
                        </div>
                        <li class="dropdown-btn-1 mt-2">Multimedia
                            <i class="fa fa-caret-down"></i>
                        </li>
                        <div class="dropdown-container-1">
                            <a href="<?php echo e(route('blog')); ?>">Blog</a><br>
                            <a href="<?php echo e(route('gallery')); ?>">Photo Gallery</a><br>
                            <a href=" <?php echo e(route('videogallery')); ?>">Video Gallery</a><br>
                        </div>
                        ...
                        <div class="dropdown-container-1">
                            <a href="<?php echo e(route('service.show')); ?>">Spa</a><br>
                            <a href="<?php echo e(route('service.show')); ?>">Swimming</a><br>
                            <a href="<?php echo e(route('service.show')); ?>">Gym</a><br>
                        </div>

                        <li class="item-155"><a href="<?php echo e(route('champadevi.show')); ?>" class="text-white">ChampaDevi info</a></li>
                        <li class="item-157"><a href="<?php echo e(route('major.show')); ?>" class="text-white"> Major Attraction</a></li>
                        <li class="item-157"><a href="<?php echo e(route('local')); ?>" class="text-white"> Local Interaction</a></li>
                        <li class="item-158"><a href="<?php echo e(route('review.show')); ?>" class="text-white">Reviews</a></li>
                        <li class="item-159"><a href="<?php echo e(route('contact')); ?>" class="text-white"> Contact</a></li>
                        <li class="item-176">
          ...
          <div class="uk-container uk-container-expand">
            <nav class="uk-navbar"
              ...
              <div class="uk-navbar-left" style="margin-top:-90px;">
                <a href="https://chr.com.np" aria-label="Back to home" class="uk-logo uk-navbar-item">
                  <img alt="CHR" loading="eager" width="350px" height="326" src="<?php echo e(asset('assets/images/assets/removebg-preview.png')); ?> "></a>
                      ...
                      <div class="container" style="margin-left: 84px;">
                        <nav>
                          <ul class="mcd-menu">
                            ...
                            <li>
                              <a href="<?php echo e(route('about-us.show')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            $restaurant = \App\Models\Restaurant::first();
                            ?>
                              <a href="<?php echo e(route('restaurant.detail', $restaurant->slug)); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <div class="dropdown-container">
                              <a href="<?php echo e(route('balkumari.show')); ?>" class="text-white mb-3">BallKumari Hall</a>
                              <a href="<?php echo e(route('bishnudevi')); ?>" class="text-white mb-3">Bishnudevi & Birkheshow Hall</a>
                              <a href="<?php echo e(route('bagh')); ?>" class="text-white mb-3">Bagh Bhairab Hall</a>
                            </div>
                            ...
                            <div class="dropdown-container">
                              <a href="<?php echo e(route('blog')); ?>" class="text-white mb-3">Blog</a>
                              <a href="<?php echo e(route('gallery')); ?>" class="text-white mb-3">Photo Gallery</a>
                              <a href="<?php echo e(route('videogallery')); ?>" class="text-white mb-3">Video Gallery</a>
                            </div>
                            <li>
                              <a href="<?php echo e(route('service.show')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <li>
                              <a href="<?php echo e(route('champadevi.show')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <li>
                              <a href="<?php echo e(route('major.show')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <li>
                              <a href="<?php echo e(route('local')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <li>
                              <a href="<?php echo e(route('review.show')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
                            ...
                            <li>
                              <a href="<?php echo e(route('contact')); ?>" class="d-flex align-items-center text-decoration-none gap-3">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
      ...
      <a class="navbar-brand" href="https://chr.com.np">
        <img src="<?php echo e(asset('assets/images/assets/removebg-preview.png')); ?>" alt="Logo" width="140" height="50">
      </a>
      ...
      <div class="d-flex align-items-center mx-auto gap-3">
        ...
        <div class="d-none d-lg-flex">
          <ul class="navbar-nav align-items-center">
            ...
            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('about-us.show')); ?>">About</a></li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu navbar-dropdown-menu">
                <?php $__currentLoopData = \App\Models\Room::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <li><a class="dropdown-item mb-1" href="<?php echo e(route('room.detail', $room->id)); ?>"><?php echo e($room->name); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </li>
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu navbar-dropdown-menu">
                <li><a class="dropdown-item mb-1" href="<?php echo e(route('balkumari.show')); ?>">BalKumari Hall</a></li>
                <li><a class="dropdown-item mb-1" href="<?php echo e(route('bishnudevi')); ?>">Bishnudevi Hall</a></li>
                <li><a class="dropdown-item mb-1" href="<?php echo e(route('bagh')); ?>">Bagh Bhairab Hall</a></li>
              </ul>
            </li>
            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('restaurant.detail', $restaurant->slug)); ?>">Food & Drinks</a></li>
    ...
    <div class="offcanvas offcanvas-end bg-dark text-white" tabindex="-1" id="sidebar" aria-labelledby="sidebarLabel">
        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('about-us.show')); ?>">About</a>
                </li>
                <li class="nav-item">
                    ...
                    <div class="sidebar-dropdown-content">
                        <?php $__currentLoopData = \App\Models\Room::all(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $room): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a class="nav-link" href="<?php echo e(route('room.detail', $room->id)); ?>"><?php echo e($room->name); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="sidebar-dropdown-content">
                        <a class="nav-link" href="<?php echo e(route('balkumari.show')); ?>">BalKumari Hall</a>
                        <a class="nav-link" href="<?php echo e(route('bishnudevi')); ?>">Bishnudevi Hall</a>
                        <a class="nav-link" href="<?php echo e(route('bagh')); ?>">Bagh Bhairab Hall</a>
                    </div>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('restaurant.detail', $restaurant->slug)); ?>">Food & Drinks</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('major.show')); ?>">Sightseeing & Activities</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('review.show')); ?>">Review</a>
                </li>
                <li class="nav-item">
...
</script><?php /**PATH C:\xampp\htdocs\CHR\resources\views/partials/frontend_navbar.blade.php ENDPATH**/ ?>