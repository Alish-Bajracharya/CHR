...
<div class="container mx-auto px-3">
    ...
    <div class="py-3 about-head">
        ...
        <div class="two-column-text px-md-5">
            <?php echo $aboutUs->long_description; ?>
...
<style>
  .about-container {
    height: 800px;
    background-image: url('<?php echo e(asset('storage/'.$aboutUs->feature_image)); ?>');
...
<!-- <div id="carouselExampleControlsNoTouching" class="carousel slide"  data-bs-ride="carousel" data-bs-interval="500">
    <div class="carousel-inner">
        <?php $__currentLoopData = $aboutUs->carousel_images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                <img src="<?php echo e(asset('storage/'.$image['image'])); ?>" class="d-block w-100" alt="...">
            </div>
...
<div class="container page-top py-4">
        <div class="row pe-4">
            ...
            <div class="col-lg-4 col-md-5 col-xs-6 thumb">
                <a href="<?php echo e(asset('storage/'.$image['image'])); ?>" class="fancybox" rel="ligthbox">
                    <img src="<?php echo e(asset('storage/'.$image['image'])); ?>" class="zoom img-fluid" alt="">
                </a>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
      ...
      <div class="text-slider-container " style="background-color:#F1F1F1;">
        ...
        <div class="col-lg-6" style="position: relative; margin-top: 60px;">
          <div class="card">
            <img
              src="<?php echo e(asset('assets/images/chr-content.jpg')); ?> "
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CHR\resources\views/frontend/about.blade.php ENDPATH**/ ?>