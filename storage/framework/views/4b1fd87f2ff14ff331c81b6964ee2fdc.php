...
<div
    ...
    style="
        max-height: 900px;
        min-height: 800px;
        background: url('<?php echo e(asset('storage/'.$room->featured_image)); ?>') center center/cover no-repeat;
        ...
        <div class="row justify-content-center align-items-center g-0">
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                <div class="d-flex flex-column align-items-center room-icon p-3">
                    ...
                    <p class="fs-5 text-white mb-0"><?php echo e($room->size); ?></p>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4 mb-3 mb-md-0">
                <div class="d-flex flex-column align-items-center room-icon p-3" style="background-color:#347e7b">
                    ...
                    <p class="fs-5 text-white mb-0"><?php echo e($room->name); ?></p>
                </div>
            </div>
            ...
            <div class="col-12 col-sm-6 col-md-4">
                <div class="d-flex flex-column align-items-center room-icon p-3" style="background-color:#4d8e8c;">
                    ...
                    <p class="text-white mb-0"><?php echo e($room->capacity); ?> Person</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container page-top py-4">
        <div class="row pe-4">
            ...
            <div class="col-lg-4 col-md-5 col-xs-6 thumb">
                <a href="<?php echo e(asset('storage/'.$image)); ?>" class="fancybox" rel="ligthbox">
                    <img src="<?php echo e(asset('storage/'.$image)); ?>" class="zoom img-fluid" alt="">
                </a>
            </div>
    ...
    <div class="carousel-inner">
        <?php $__currentLoopData = $room->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="carousel-item <?php echo e($index === 0 ? 'active' : ''); ?>">
                <img src="<?php echo e(asset('storage/'.$image)); ?>" class="d-block w-100" alt="Room Image">
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
<section class="py-5 pe-4" style="background-color: #F1F1F1;">
    <div class="container mx-auto">
       ...
       <div class="col-md-4 col-lg-3">
         ...
         <a href="<?php echo e(route('room.detail', $room->id)); ?>"class="text-white"><div class="room-card">
        <img src="<?php echo e(asset('storage/' . $room->featured_image)); ?>" alt="Super Deluxe Room" class="room-image"> <!-- Replace with your image -->
         <div class="room-info">
...
<?php echo $__env->make('frontend.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CHR\resources\views/frontend/suiteroom.blade.php ENDPATH**/ ?>